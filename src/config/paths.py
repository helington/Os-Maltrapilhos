...
BOSS_PATH = path.join(GRAPHICS_PATH, "boss")
BOSS_DEATH_PATH = path.join(BOSS_PATH, "Death")
BOSS_MOUTH_PATH = path.join(BOSS_PATH, "Mouth")
...
BOSS_ATTACK_PATH = path.join(BULLET_PATH, "boss_attack")
...
ICON_PATH = path.join(PLAYER_PATH, "Icon")